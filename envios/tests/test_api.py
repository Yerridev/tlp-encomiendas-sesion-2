...
class TestCrearEncomienda:
    ...
    def test_crear_exitoso_devuelve_201(self):
        response = self.client.post('/api/v1/encomiendas/', self.data_valida, format='json')
    ...
    def test_crear_asigna_empleado_del_token(self):
        self.client.post('/api/v1/encomiendas/', self.data_valida, format='json')
    ...
    def test_remitente_igual_destinatario_devuelve_400(self):
        ...
        response = self.client.post('/api/v1/encomiendas/', data, format='json')
    ...
    def test_sin_auth_no_crea_y_devuelve_401(self, api_client):
        response = api_client.post('/api/v1/encomiendas/', self.data_valida, format='json')
        assert response.status_code == status.HTTP_401_UNAUTHORIZED
